...
// ── DATA — All 25 original modules grouped into 7 modules ──────
const modulesData = [
    {
        id: "01",
        title: "Digital Foundations & Strategy",
        desc: "Build the strategic groundwork — from core marketing concepts to planning and creative design.",
        subtopics: [
            {
                title: "Digital Marketing Basics",
                desc: "Scope of digital marketing, assessing various channels, marketing fundamentals, paid media portals and networks, social platforms, SEO importance, marketing tactics, and web analytics.",
            },
            {
                title: "Digital Planning & Strategy",
                desc: "Importance of strategy, situational analysis, understanding client requirements, strategy creation, and practical implementation.",
            },
            {
                title: "Content & Media Marketing",
                desc: "Content strategy, audience research, content creation, SEO integration, content distribution, and analytics.",
            },
            {
                title: "Creative Designing (Canva + Adobe Express)",
                desc: "Introduction to graphic design platforms, creating visual content, basic tools and features, templates and layouts, customization options, typography and branding, collaboration and sharing, exporting and printing, and advanced features.",
            },
            {
                title: "Viral Marketing",
                desc: "Understanding viral content, psychological triggers, content creation for virality, distribution channels, campaign planning, KPIs and analytics, and case studies.",
            },
        ],
    },
    {
        id: "02",
        title: "Website, Landing Pages & SEO",
        desc: "Build professional web properties and rank them organically on search engines.",
        subtopics: [
            {
                title: "Website Creation on WordPress",
                desc: "WordPress intro, installation and settings, dashboard navigation, links structure, themes and plugins, slider customization, and export/import of website.",
            },
            {
                title: "Landing Page Design using Elementor",
                desc: "Landing page fundamentals, Elementor basics, layout planning, widgets customization, conversion optimization, email integration, analytics and tracking, and case studies.",
            },
            {
                title: "Blog Creation & Monetization",
                desc: "Blog setup, choosing a niche, content creation, SEO basics, audience building, monetization strategies, affiliate marketing, ad networks, and performance analysis.",
            },
        ],
    },
    {
        id: "03",
        title: "Analytics, Tags & Tracking",
        desc: "Set up precise measurement systems to track every visitor, event, and conversion.",
        subtopics: [
            {
                title: "Google Analytics 4",
                desc: "GA4 setup, campaign tracking, goals and filters, advanced segmentation, event tracking, e-commerce tracking, and detailed reports.",
            },
            {
                title: "Webmaster Tools (Google Search Console)",
                desc: "Search Console setup, performance metrics — clicks, impressions, CTR and position, URL inspection, index coverage, sitemaps, mobile usability, security, and backlinks.",
            },
            {
                title: "Google Tag Manager",
                desc: "Tags, triggers, and variables, GTM setup and installation, tag implementation, custom HTML and JS tags, e-commerce tracking, and GDPR compliance.",
            },
            {
                title: "Google AdSense",
                desc: "AdSense basics, account setup, creating ad units, and website monetization strategies.",
            },
        ],
    },
    {
        ...
        desc: "Drive immediate, measurable results across Google, YouTube, and social platforms.",
        subtopics: [
            {
                title: "Search Engine Marketing (SEM)",
                desc: "Google Ads basics, campaign types, keyword research, ad copywriting, bidding strategies, campaign optimization, and remarketing.",
            },
            {
                title: "Social Media Advertising",
                desc: "Meta ads, campaign setup, audience targeting, ad formats and creative, campaign optimization, and performance reporting.",
            },
            {
                title: "YouTube Advertising",
                desc: "Channel setup, conversion tracking, video optimization, audience targeting, retargeting, and scaling campaigns.",
            },
            {
                title: "Media Buying & Planning",
                desc: "Meaning and importance of media buying, key formulas and KPIs, Excel for media planning, brand requirement analysis, media strategy creation, and execution planning.",
            },
            {
                title: "Mobile Marketing",
                desc: "Mobile trends, app ads and in-game marketing, location-based ads, SMS and push notifications, mobile keyword research, landing page optimization, and Play Store optimization.",
            },
        ],
    },
    {
        ...
        desc: "Grow brand presence organically and through strategic influencer partnerships.",
        subtopics: [
            {
                title: "Social Media Marketing (Organic)",
                desc: "Platform understanding, creating business pages, posting strategies, growing followers, audience insights, best practices, hashtags, and content strategy.",
            },
            {
                title: "Influencer Marketing",
                desc: "Basics of influencer marketing, identifying the right influencers, campaign planning, execution strategies, tracking performance, and legal compliance.",
            },
            {
                title: "Online Reputation Management (ORM)",
                desc: "Basics of ORM, engaging with customers and building positive links, reputation defending techniques, ORM through social channels, ORM through SEO, SEO blog creation, positive seeding, measuring audience sentiments, ORM tools, dealing with panic situations, and social listening tools.",
            },
        ],
    },
    {
        id: "06",
        title: "Email, Automation & CRM",
        desc: "Build automated marketing systems that nurture leads and drive repeat conversions.",
        subtopics: [
            {
                title: "Email Marketing",
                desc: "Types of email marketing, email marketing basics, choosing a platform, autoresponders and broadcasts, email content writing, B2B and B2C practices, growing email list, CTA strategies, and reporting and optimization.",
            },
            {
                title: "Drip Marketing & Email Automation",
                desc: "Lead generation and segmentation, re-engagement strategies, managing unopened emails, sales funnels, CRM basics, SMS and drip campaigns, retargeting, push notifications, and abandoned cart emails.",
            },
            {
                title: "WhatsApp Chatbot & Automation",
                desc: "Chatbot setup, WhatsApp Business API, automation flows, message personalization, analytics, and optimization.",
            },
        ],
    },
    {
        id: "07",
        title: "Monetization, Affiliate & Freelancing",
        desc: "Turn your digital skills into revenue — through affiliate marketing, freelancing, and client work.",
        subtopics: [
            {
                title: "Affiliate Marketing",
                desc: "Introduction to affiliate marketing, understanding the affiliate ecosystem, joining affiliate networks, building your platform, SEO and content for affiliates, promotion strategies, tracking and analytics, conversion optimization, compliance, and scaling.",
            },
            {
                title: "Digital Marketing Freelancing",
                desc: "Freelancing basics, setting up your business, finding clients, applying SEO, SEM and content marketing for client projects, portfolio building, project management, and scaling your freelancing business.",
            },
        ],
    },
];
...
export default function SyllabusSection() {
    ...
    return (
        <section
            ...
            aria-label="Advanced Diploma Syllabus"
        >
            {/* ── Background ── */}
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto">
                ...
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
                        ...
                        <p className="text-[15px] md:text-[17px] font-medium text-gray-600 leading-relaxed">
                            From SEO fundamentals to advanced paid advertising — 7 modules covering all 25 topics of the Advanced Diploma curriculum.
                        </p>
                    </motion.div>
                </div>
                ...
                >
                    {/* LEFT — dark sidebar */}
                    <div className="border-r border-white/10 overflow-y-auto max-h-[600px] custom-scroll bg-[#0f172a]">
                    ...
                    {/* MIDDLE — subtopics */}
                    <div className="border-r border-gray-100 overflow-y-auto max-h-[600px] custom-scroll bg-white">
                    ...
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className="overflow-y-auto max-h-[600px] custom-scroll flex flex-col bg-white"
                        >
